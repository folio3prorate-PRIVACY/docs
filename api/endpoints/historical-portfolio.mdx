...
<Note>
  **Interactive Playground:** Test this endpoint in the [API Playground](/api-reference/historical-portfolio). Get your API key at [data.octav.fi](https://data.octav.fi/)
</Note>
