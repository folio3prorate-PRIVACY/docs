...
<CardGroup cols={2}>
  ...
  <Card title="SOC 2 Type 1" icon="shield-check">
    **Design Compliance**
...
<Steps>
  ...
  <Step title="Contact Support" icon="headset">
    If issues persist, email support@octav.fi
  </Step>
</Steps>

<Warning>
  **Account Recovery** — For account access issues, please contact support@octav.fi with your account email address.
</Warning>
...
<CardGroup cols={3}>
  ...
  <Card title="Email Support" icon="envelope" href="mailto:support@octav.fi">
    support@octav.fi
  </Card>
