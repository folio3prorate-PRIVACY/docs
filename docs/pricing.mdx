...
<AccordionGroup>
  ...
  <Accordion title="Can I upgrade my plan?" icon="arrow-up">
    Yes! You can upgrade from Free to Lite or Pro at any time. When you upgrade, you'll be charged the prorated amount for the remainder of the billing period.
  </Accordion>

  <Accordion title="What payment methods do you accept?" icon="credit-card">
    We accept cryptocurrency payments via Coinbase Commerce through the app. For Institutional plans, we also support wire transfers.
  </Accordion>
