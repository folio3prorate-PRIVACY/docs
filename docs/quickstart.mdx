...
<Steps>
  ...
  <Step title="Add Your First Wallet" icon="wallet">
    ...
    Connect the wallets you want to track:
  ...
  <Step title="Explore Your Dashboard" icon="chart-line">
    ...
    Once your wallet is connected, your dashboard comes to life with:
...
<Info>
  **Having trouble?** Join our [Discord community](https://discord.gg/qvcknAz73A) for instant support from the Octav team and community members.
</Info>
